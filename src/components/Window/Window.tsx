...
const Window = (props: WindowProps) => {
  ...
  return (
    <Rnd
      ...
      className={`absolute ${round} overflow-hidden bg-red w-full gap-y-1 h-full ${border} shadow-md ${minimized}`}
      id={`window-${props.id}`}
    >
      <div
      ...
      <div className="innner-window w-full bg-gray-500">{children}</div>
    </Rnd>
  );
};
