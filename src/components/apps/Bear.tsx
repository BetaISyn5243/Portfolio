...
const Sidebar = ({ cur, setMidBar }: SidebarProps) => {
  return (
    <div className="nightwind-prevent nightwind-prevent-block sidebar w-auto h-full bg-gray-700 text-white ">
...
const Middlebar = ({ items, cur, setContent }: MiddlebarProps) => {
  return (
    <div className="midbar w-auto h-full bg-gray-50 border-r border-gray-300 ">
      <ul>
...
const Content = ({ contentID, contentURL }: ContentProps) => {
  ...
  return (
    <div className="markdown h-full bg-gray-50 text-gray-700 py-6 overflow-hidden" style={styl1}>
...
const Bear = () => {
  ...
  return (
    <div className="bear font-avenir flex flex-row w-full ">
